...
let name.getInput(`What do we call you, traveler?`);
// 3. Console.log name
console.log(name);
// 4. return name
return name;
...
if(input === h){
  ...
  console.log('Invalid Entry! "h" or "l" only!');
}
}
